...
function Main() {
  ...
  //setup a realtime connection to the server,update the app state with new socket
  useEffect(()=>{
    if(userInfo){
  ...
  useEffect(()=>{
    if(socket.current && !socketEvent){
      ...
      socket.current.on("mark-read-receive", ({ id, receiverId }) => {
        dispatch({
  ...
  //get messages for the current chat user
  useEffect(()=>{
